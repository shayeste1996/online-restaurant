export class ScrollSpy {
  ...
  setActive(activeItem) {
    ...
    if (!isActive) {
      ...
      //const bubble = document.querySelector(".categoryCarouselBubble");
      //bubble.style.width = activeItem.clientWidth + "px";
      //bubble.style.left = activeItem.offsetLeft + "px";
      const category = document.querySelector(".categoryCarouselScroll");
